...
```{r}
world %>% str # sf and dataframe
world$geom # a geometry set
world[0] # a sfc (simple feature collection)
world[0] %>% str # sf and dataframe
world$geom %>% plot
world[0] %>% plot
world[0] %>% all.equal(world$geom) # NOPE
world$geom %>% str # sfc_MULTIPOLYGON
world$geom %>% summary
world$geom[1] %>% str
world$geom[15] %>% str
world$geom[1]
...
```{r}
plot(st_as_sfc("MULTIPOLYGON (((1 5, 2 2, 4 1, 4 4, 1 5), (0 2, 1 2, 1 3, 0 3, 0 2), ((1 5, 2 2, 4 1, 4 4, 1 5), (2 4, 3 4, 3 3, 2 3, 2 4))))"), col = "gray", axes = TRUE, main = "MULTIPOLYGON with hole")
```
...
my_raster <- 
  raster(nrow = 10,
         ncol = 10)
my_raster
values(my_raster) <- runif(n = 100, 0, 10)
plot(my_raster)
```
